...
import 'models/users_model_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  sendData(index) async {
    await users.add(data[index]).then((value) {
      ...
      debugPrint("Fail to Send Data : $error");
    });
  }
  ...
  getData() async {
    await users.get().then((value) {
      ...
      listOfUsers.add(Users.fromJson(jsonDecode(jsonEncode(doc.data()))));
      debugPrint("listOfUser =====>> ${jsonEncode(listOfUsers)} ");
      setState(() {});
      }
    }).catchError((error) {
